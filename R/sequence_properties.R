...
#                                          letters = "GC") |>
#              as.numeric()) |>
#   qs::qsave("intermediates/240305_event_coords/240305_a3_seq.qs")
...
#                                          letters = "GC") |>
#              as.numeric()) |>
#   qs::qsave("intermediates/240305_event_coords/240305_a5_seq.qs")
...
data.frame(event_id = d_af$event_id,
  ...
  qs::qsave("intermediates/240305_event_coords/240305_af_seq.qs")
...
#              as.numeric()
#            ) |>
#   qs::qsave("intermediates/240305_event_coords/240305_al_seq.qs")
...
#              as.numeric()
#            ) |>
#   qs::qsave("intermediates/240305_event_coords/240305_mx_seq.qs")
...
#                                          letters = "GC") |>
#              as.numeric()) |>
#   qs::qsave("intermediates/240305_event_coords/240305_ri_seq.qs")
...
#                                        letters = "GC") |>
#              as.numeric()) |>
#   qs::qsave("intermediates/240305_event_coords/240305_se_seq.qs")
